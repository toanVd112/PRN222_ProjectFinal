...
=======
        => optionsBuilder.UseSqlServer("Server=DESKTOP-CE9FVAP;Database=PRN_Project;User Id=sa;Password=123;TrustServerCertificate=True;");
>>>>>>> feature/ChienNM/TECHNICIAN(Thêm/Sửa-thông-tin-thiết-bị)
